...
class KitchenTimer{
    constructor(_name, _remainingSeconds, _isRunning){
        this._name = _name;
        this._remainingSeconds = 0;
        this._isRunning = false;
        window.setInterval(() =>{
            if(this._isRunning === true && 0 < this._remainingSeconds){
...
const timer1 = new KitchenTimer();
timer1._name = 'タイマー1';
timer1.setSeconds(3);

const timer2 = new KitchenTimer();
timer2._name = 'タイマー2';
timer2.setSeconds(5);
